...
class Features_Lead_Predict(FlaskForm):
    target_converted_users = IntegerField('Target Converted Users', default=random.randint(2, 199), validators=[DataRequired(), NumberRange(min=1, max=150, message='Value must be between 1 and 200')])
